...
public class MemoryUsageDemo extends JPanel {
    ...
    public MemoryUsageDemo(int maxAge) {
        ...
        // seconds old...
        this.total = new TimeSeries("Cpu max possible usage", Millisecond.class);
        this.total.setMaximumItemAge(maxAge);
        this.free = new TimeSeries("Cpu load", Millisecond.class);
        ...
        NumberAxis range = new NumberAxis("Cpu usage");
    ...
    class DataGenerator extends Timer implements ActionListener {
        ...
        public void actionPerformed(ActionEvent event) {
                ...
                addFreeObservation((operatingSystemMXBean.getSystemCpuLoad())*100);
                addTotalObservation(100);
    ...
    public static void main(String[] args)  {
        ...
        JFrame frame = new JFrame("Cpu usage demo");
